...
public class Task5 {
    ...
    public double computeMaxDensityForWallConstruction(double[] materialBurningTemperature, double[] componentAvrSpeedBurn) {
        double result;
    ...
    public double computeMaxDensityForCoverageConstruction(double[] materialBurningTemperature, double[] componentAvrSpeedBurn) {
        double result;
